...
![](https://cdn.jsdelivr.net/gh/Orzjh/blog-resources@_md2zhihu_LangChain_526fd4eb/LangChain 系列教程（三）：Retrieval/ed7b2605a3a77a1d-1.png)
...
![](https://cdn.jsdelivr.net/gh/Orzjh/blog-resources@_md2zhihu_LangChain_526fd4eb/LangChain 系列教程（三）：Retrieval/e99fadd6d68f90b8-6.png)
...
![](https://cdn.jsdelivr.net/gh/Orzjh/blog-resources@_md2zhihu_LangChain_526fd4eb/LangChain 系列教程（三）：Retrieval/955e4e73ce5282ed-2.png)
...
![](https://cdn.jsdelivr.net/gh/Orzjh/blog-resources@_md2zhihu_LangChain_526fd4eb/LangChain 系列教程（三）：Retrieval/92378b6cbbdf28b0-3.png)
...
![](https://cdn.jsdelivr.net/gh/Orzjh/blog-resources@_md2zhihu_LangChain_526fd4eb/LangChain 系列教程（三）：Retrieval/f184e3e578ff68ce-4.png)

1.  **文档嵌入**：将每段文档通过**拆分和嵌入模型**转化为向量，并存入向量数据库；

1.  **问题嵌入**：用户提问也被嵌入为向量；

1.  **相似度计算**：计算问题向量与所有文档向量之间的相似度（如余弦相似度）；

1.  **返回结果**：取出最相似的 top-k 文档，作为回答依据。
